...
class BotMetadata(metaclass=Singleton):
	warnings.warn(
		"This class is legacy, and is Depricated, new version is in data_handler.data_handler.BotMetadata",
		DeprecationWarning,
		stacklevel=2,
	)
	...
	def __init__(self):
		try:
			...
			logger.error(
				"ERROR- Either the bot_metadata.json file is empty or the data-format is inconsistant"
			)
			exit(-1)
...
class SeleniumConfigs:
	...
	RETWEET_ICON1 = {
		"by": By.CSS_SELECTOR,
		"value": '.css-18t94o4[data-testid ="retweet"]',
	}
...
class ReportingIconWorkflow:
	workflow = [
		...
		"someone_else_option",
		"next_button",
		"attacked_coz_of_identity_option",
		"next_button",
		"wishing_harm_coz_of_identity_option",
		"next_button",
		"religion_option",
		"next_button",
		"tweets_option",
...
class MailConfigs:
	...
	EMAIL_FIELD = {
		"by": By.CSS_SELECTOR,
		"value": '*[data-test="check-email-availability-email-input"]',
	}
	GENDER_OPT = {
		"by": By.CSS_SELECTOR,
		"value": ".ng-touched:nth-child(2) .pos-input-radio__checker",
	}
	FIRSTNAME_FIELD = {
		"by": By.CSS_SELECTOR,
		"value": '*[data-test="first-name-input"]',
	}
